...
import online.lbprotocol.easy.jdbc.mapper.EntityRowMapper;
...
public class EntityDao extends BaseDao {
    ...
    public <T> Pair<Integer, List<T>> findAndCount(String modelName, Map<String, Object> condition, int pageNumber, RowMapper<T> rowMapper, String orderBy, String orderOption) {
        return findAndCount(modelName, condition, pageNumber, PAGE_SIZE_MEDIUM, rowMapper, orderBy, orderOption);
    }
    ...
    public List<Entity> findByOffset(String modelName, Map<String, Object> condition, Map<Pair<String, String>, Object> offsets, int pageSize) {
        return findByOffset(modelName, condition, offsets, ORDER_BY_ID, ORDER_OPTION_ASC, 1, pageSize, EntityRowMapper.getInstance());
    }
    ...
    public List<Entity> findByOffset(String modelName, Map<String, Object> condition, Map<Pair<String, String>, Object> offsets, int pageNumber, int pageSize) {
        return findByOffset(modelName, condition, offsets, ORDER_BY_ID, ORDER_OPTION_ASC, pageNumber, pageSize, EntityRowMapper.getInstance());
    }
    ...
    public List<Entity> findByOffset(String modelName, Map<String, Object> condition, Map<Pair<String, String>, Object> offsets, int pageNumber, int pageSize, String orderBy) {
        return findByOffset(modelName, condition, offsets, orderBy, ORDER_OPTION_ASC, pageNumber, pageSize, EntityRowMapper.getInstance());
    }
    ...
    public <T> List<T> findByOffset(String modelName, Map<String, Object> condition, Map<Pair<String, String>, Object> offsets, int pageSize, RowMapper<T> rowMapper) {
        return findByOffset(modelName, condition, offsets, ORDER_BY_ID, ORDER_OPTION_ASC, 1, pageSize, rowMapper);
    }
    ...
    public List<Entity> findByOffset(String modelName, Map<String, Object> condition, Map<Pair<String, String>, Object> offsets, int pageSize, String orderBy) {
        return findByOffset(modelName, condition, offsets, orderBy, ORDER_OPTION_ASC, 1, pageSize, EntityRowMapper.getInstance());
    }
    ...
    public <T> List<T> findByOffset(String modelName, Map<String, Object> condition, Map<Pair<String, String>, Object> offsets, String orderBy, int pageNumber, int pageSize, RowMapper<T> rowMapper) {
        return findByOffset(modelName, condition, offsets, orderBy, ORDER_OPTION_ASC, pageNumber, pageSize, rowMapper);
    }
    ...
    public <T> List<T> findByOffset(String modelName, Map<String, Object> condition, Map<Pair<String, String>, Object> offsets, String orderBy, int pageSize, RowMapper<T> rowMapper) {
        return findByOffset(modelName, condition, offsets, orderBy, ORDER_OPTION_ASC, 1, pageSize, rowMapper);
    }
    ...
    public <T> T findOne(String modelName, Map<String, Object> condition, RowMapper<T> rowMapper) {
        return findOne(modelName, condition, rowMapper, ORDER_BY_ID, ORDER_OPTION_DESC);
    }

    public <T> T findOne(String modelName, Map<String, Object> condition, RowMapper<T> rowMapper, String orderOption) {
        return findOne(modelName, condition, rowMapper, ORDER_BY_ID, orderOption);
    }
    ...
    public <T> T findOne(String modelName, String columnName, Object columnValue, RowMapper<T> rowMapper) {
        return findOne(modelName, columnName, columnValue, rowMapper, ORDER_BY_ID, ORDER_OPTION_DESC);
    }
